...
(function () {
  ...
  /* ------------------------------------------------------------------------
     ...
     ------------------------------------------------------------------------ */
  /* بوابةُ المكتب في نظام الرائد — الشركة #392، نطاقٌ خاصٌّ مربوطٌ ومتحقَّق.
     ⚠️ لا تُبدّله بجذر المنصّة `alraedlaw.com`: الدخولُ من الجذر لا يمرّ إلا
     لمُلّاك الشركات ومدير المنصّة، فيُحجب موظّفو المكتب وعملاؤه. */
  var PORTAL_MODE = "link";
  var PORTAL_URL = "https://app.mutared.com";
